  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg-primary)' }}>
      ...
      <div style={{ 
        ...
        position: 'relative',
        overflow: 'hidden',
        background: 'radial-gradient(circle at bottom center, rgba(99, 102, 241, 0.15) 0%, rgba(10, 10, 15, 1) 70%)',
        ...
        <div style={{
          ...
          background: 'var(--accent-glow)', filter: 'blur(120px)', borderRadius: '50%',
          bottom: '-10%', left: '-10%'
        }}></div>
        ...
        <div style={{ zIndex: 1, color: 'white', maxWidth: '400px' }}>
          <div className="flex items-center gap-2 mb-6" style={{ background: 'rgba(255,255,255,0.05)', display: 'inline-flex', padding: '0.5rem 1rem', borderRadius: 'var(--radius-full)' }}>
            ...
            <span style={{ fontSize: '0.875rem', fontWeight: 500 }}>Join the Revolution</span>
          </div>
          <h1 style={{ fontSize: '3.5rem', lineHeight: 1.1, fontWeight: 700, marginBottom: '1.5rem' }}>
            Start <span style={{ color: 'var(--accent-primary)' }}>building wealth</span> today.
          </h1>
          <p className="subtitle" style={{ fontSize: '1.1rem', lineHeight: 1.6 }}>
            Set up your AI financial manager in minutes and let our intelligent engine do the heavy lifting of categorizing expenses.
          </p>
          ...
          <div className="glass-card mt-4 flex items-center gap-4" style={{ padding: '1rem', width: 'fit-content' }}>
            ...
            <div>
              <div style={{ fontSize: '0.875rem', color: 'var(--text-muted)' }}>Bank-level Security</div>
              <div style={{ fontWeight: 600, fontSize: '1.1rem' }}>256-bit Encryption</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
        <div className="glass-card" style={{ width: '100%', maxWidth: '440px', padding: '3rem' }}>
          ...
          <h3 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem', color: 'white' }}>Create an account</h3>
          <p className="text-muted mb-6">Start your intelligent financial journey here.</p>

          <form className="flex-col gap-4">
            <div className="flex-col gap-1">
              <label style={{ fontSize: '0.875rem', color: 'var(--text-muted)' }}>Full Name</label>
              <input type="text" placeholder="John Doe" className="w-full" required />
            </div>
